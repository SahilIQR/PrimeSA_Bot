...
module.exports = {
    ...
    aliases: ['viewoncev2'],
    category: 'general',
    description: 'Forward replied view-once media to the owner privately',
...
const ownerNumber = String(ownerNumbers[0] || '')
    .replace(/[^0-9]/g, '');

if (!ownerNumber) {
    return await sock.sendMessage(
        chatId,
        { text: '❌ Owner number is not configured correctly.' },
        { quoted: msg }
    );
}
